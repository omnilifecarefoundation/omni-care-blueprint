  ...
  makePolicyRoute({
    ...
    body: (
      <div className="space-y-6 text-ink-muted leading-relaxed">
        ...
        <h2 className="font-sans font-semibold tracking-[-0.015em] text-2xl text-ink">What we collect</h2>
        <p>Name, email, phone, postal address, PAN (for tax receipts), and any information you choose to share via forms.</p>
        <h2 className="font-sans font-semibold tracking-[-0.015em] text-2xl text-ink">How we use it</h2>
        ...
        <h2 className="font-sans font-semibold tracking-[-0.015em] text-2xl text-ink">Your rights</h2>
