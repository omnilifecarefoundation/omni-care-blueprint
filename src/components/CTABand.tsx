    ...
    return (
      <section className="bg-canvas">
        <div className="container-editorial py-16 lg:py-24">
          <div className="relative overflow-hidden rounded-3xl bg-primary text-snow outline outline-1 -outline-offset-1 outline-snow/10 shadow-[0_1px_2px_rgba(15,17,23,0.08),0_30px_60px_-28px_rgba(15,17,23,0.45)]">
            <div
              aria-hidden="true"
            ...
            <div className="relative px-7 py-14 sm:px-10 sm:py-16 lg:px-16 lg:py-20">
              <div className="grid lg:grid-cols-[1.5fr_1fr] gap-10 lg:gap-14 items-end">
                <div className="space-y-6">
                  ...
                  <FadeUp delay={80}>
                    <h2 className="font-sans font-semibold text-[clamp(1.75rem,3.2vw,2.5rem)] leading-[1.08] tracking-[-0.02em] text-snow text-balance">
                      {title}
                    </h2>
                  </FadeUp>
                  {body && (
